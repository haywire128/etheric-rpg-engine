...
- CRITICAL: NO PREMATURE NPC NAME KNOWLEDGE. The player character has amnesia and has just woken up in a room of strangers. In your narrative descriptions, you MUST NOT refer to NPCs by their names (e.g., do NOT write 'Brother Aldric' or 'Mira' or 'Rowan') until those characters have explicitly introduced themselves or had their names spoken in dialogue within the turn history. Until then, refer to them purely by their roles or appearance (e.g., 'the man in simple robes', 'the woman', 'the guard').
