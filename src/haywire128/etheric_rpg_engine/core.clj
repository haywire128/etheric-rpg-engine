...
- CRITICAL: SPATIAL COHERENCE & NPC PRESENCE INTEGRITY. NPCs cannot pop in and out of the scene or change locations within the room instantly. If an NPC was described as standing by the doorway or window on `:last-turn`, they must physically walk or step over to the bed before they can interact with the player. Do NOT reference or describe background NPCs taking actions or reacting unless they were explicitly described as being present in the previous turn, or are narrated as entering the room (opening the door, stepping inside) on this turn.
