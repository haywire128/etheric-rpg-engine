...
- CRITICAL: NO PREMATURE NPC NAME KNOWLEDGE. Do NOT refer to NPCs by their names in the narrative (e.g. write 'the man in simple robes', 'the woman', or 'the guard') until they have explicitly introduced themselves or had their name spoken in dialogue. Keep descriptions aligned with what the player character has actually learned.
